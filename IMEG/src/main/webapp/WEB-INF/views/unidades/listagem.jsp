            ...
            <tbody>
                <c:forEach items="${unidades}" var="unidade">
                    <tr>
                        ...
                        <td><center><a href="<c:url value="/unidades/editar?id=${unidade.id}"></c:url>"><i data-toggle="tooltip" data-placement="top" title="Editar" class="active-elem-table fa fa-pencil-square-o" aria-hidden="true"></i></a></center></td>                
                    </tr>
            </c:forEach>
            </tbody>
        </table>
